...
#' @param rmst_restriction The RMT cutoff value.
...
#' @param Time A m x n matrix of event times. Rows should represent events and columns should represent participants. Event rows should be
...
#' @return A vector of length resample_num containing the observed treatment effect for each permutation.
