...
#' @param etimes A sorted vector of event times (returned from wintime::setEventTimes()).
#' @param time0 A vector containing the control person's event times.
#' @param time1 A vector containing the treatment person's event times.
...
#' @param m The number of events in the hierarchy.
#' @param time The row reversal of the Time matrix (created inside wintime::km()).
...
#' @param time0 A vector of event times for the control person.
#' @param time1 A vector of event times for the treatment person.
#' @param follow The maximum follow up time.
#' @return A sorted vector of event times for a given pair.
