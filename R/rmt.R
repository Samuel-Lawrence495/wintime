...
#' @param rmst_restriction The cutoff time point for the calculation.
...
#' @param unique_event_times0 A vector of unique control arm event times (returned from wintime::km() or wintime::markov()).
#' @param unique_event_times1 A vector of unique treatment arm event times (returned from wintime::km() or wintime::markov()).
