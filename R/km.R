...
#'
#' This function fits a Kaplan-Meier model to calculate the state probabilities for each arm. In the wintime package, the returned state probability
...
#' @param Time A `m x (n0 + n1)` matrix of event times. Rows should represent events and columns should represent participants. Event rows should be
