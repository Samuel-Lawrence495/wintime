...
#' @param maxfollow The max control group follow up time (returned from wintime::markov() or wintime::km()).
#' @param untimes A vector containing unique control group event times (returned from wintime::markov() or wintime::km()).
#' @param Time A m x n matrix of event times. Rows should represent events and columns should represent participants. Rows should be
