...
#' @param Time A m x n matrix of event times, where m is the number of events in the hierarchy. Rows should represent events and columns
...
#' @return The z-statistic of the after the Cox Model is fit.
